    ...
    *****************/
    Route::prefix('admin')->name('admin.')->group(function () {
        ...
        Route::middleware(['admin', 'demo'])->group(function () {
            ...
            Route::get('reward', [HomeController::class, 'reward'])->name('reward');
            Route::get('reward/create', [HomeController::class, 'reward_create'])->name('reward.create');
            Route::post('reward/store', [HomeController::class, 'reward_store'])->name('reward.store');
            Route::post('reward/update/{id}', [HomeController::class, 'reward_update'])->name('reward.update');
            Route::get('reward/edit/{id}', [HomeController::class, 'reward_edit'])->name('reward.edit');
    ...
    Route::name('user.')->group(function () {
        ...
        Route::middleware(['auth', 'inactive', 'is_email_verified'])->group(function () {
            ...
            Route::middleware('2fa','kyc')->group(function () {
                ...
                Route::get('clm/{id}', [UserController::class, 'clm'])->name('clm');
