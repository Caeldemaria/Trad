<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="nav-item dropdown <?php echo e(menuActive('admin.reward')); ?>">
                <a href="<?php echo e(route('admin.reward')); ?>" class="nav-link ">
                    <i data-feather="home"></i>
                    <span><?php echo e(__('Reward')); ?></span>
                </a>
            </li>
...
<?php /**PATH /home/crickett20cup/trading.cricket-t20cup.com/core/resources/views/backend/layout/sidebar.blade.php ENDPATH**/ ?>