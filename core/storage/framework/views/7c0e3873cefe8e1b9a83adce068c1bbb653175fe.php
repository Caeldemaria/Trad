                            ...
                            <div class="col-md-9">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <label for=""><?php echo e(__('Gateway Number/Address')); ?></label>
                                        <input type="text" name="gateway_number"  class="form-control" value="<?php echo e($gateway->gateway_number); ?>">
                                    ...
                                    <div class="form-group col-md-4">
                                        <label><?php echo e(__('Minimum Limit')); ?></label>
                                        <div class="input-group">
                                            <input type="number" class="form-control" name="min_limit" value="<?php echo e(@$gateway->min_limit); ?>">
                                    ...
                                    <div class="form-group col-md-4">
                                        <label><?php echo e(__('Maximum Limit')); ?></label>
                                        <div class="input-group">
                                            <input type="number" class="form-control" name="max_limit" value="<?php echo e(@$gateway->max_limit); ?>">
...
<?php echo $__env->make('backend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/crickett20cup/trading.cricket-t20cup.com/core/resources/views/backend/gateways/edit.blade.php ENDPATH**/ ?>