                            ...
                            <form action="" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                     ...
                                     <div class="col-md-4 mb-3">
                                        <label for="coin_name"><?php echo e(__('Trade Minute')); ?></label>
                                        <div class="input-group">
                                            <input type="number" name="minute" placeholder="<?php echo app('translator')->get('Must be Minute'); ?>" class="form-control form_control" value="<?php echo e(@$general->minute); ?>">
                                        </div>
                                    </div>
...
<?php echo $__env->make('backend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/crickett20cup/trading.cricket-t20cup.com/core/resources/views/backend/setting/trading_setting.blade.php ENDPATH**/ ?>