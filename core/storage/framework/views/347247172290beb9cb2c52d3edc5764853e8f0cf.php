                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <?php $__currentLoopData = $section; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $sec): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if($key == "size"): ?>
                                            <div class="col-md-12 text-danger mb-3">Image Must be (<?php echo e($sec); ?>) Pixel Only.</div>
                                        <?php endif; ?>
...
<?php echo $__env->make('backend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/crickett20cup/trading.cricket-t20cup.com/core/resources/views/backend/frontend/edit.blade.php ENDPATH**/ ?>