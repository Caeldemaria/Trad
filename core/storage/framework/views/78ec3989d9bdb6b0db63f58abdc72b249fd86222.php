        ...
        <div class="card-body text-center">
            ...
            <div class="row justify-content-center">
                <div class="col-3 d-inline-block text-truncate px-1 mb-1">
                    <a class="btn btn-primary btn-sm w-100 logNav transactionLogBtn" id="logNavTransaction" href="#">Order</a>
                </div>
                <div class="col-3 d-inline-block text-truncate px-1 mb-1">
...
<?php /**PATH /home/crickett20cup/trading.cricket-t20cup.com/core/resources/views/theme3/includes/user/logs_nav.blade.php ENDPATH**/ ?>