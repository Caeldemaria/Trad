                ...
                <div class="card-body"><div style="background: #134d00;" 
                    <div class="row">
                        <div class="col-6 pr-1">
                            <a href="<?php echo e(route('user.withdraw.setting.usdt')); ?>" class="btn btn-sm btn-light w-100">Bank Card</a>
                        </div>
...
<?php echo $__env->make(template().'layout.master2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/crickett20cup/trading.cricket-t20cup.com/core/resources/views/theme3/user/withdraw/usdt.blade.php ENDPATH**/ ?>