            ...
            <div class="row">
                <div class="col-md-12 stretch-card">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('admin.reward.update', $data->id) }}">
                                @csrf
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-3">
                                     ...
                                     <div class="form-group col-md-3">
                                        ...
                                        <input type="text" class="form-control" name="tteam"
                                               value="{{ $data->tteam }}" placeholder="total team">
                                        @error('tteam')
                                        <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                                <span />
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="text" class="form-control" name="bonus"
                                               value="{{ $data->bonus }}" placeholder="bonus">
                                        @error('bonus')
                                        <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                                <span />
                                ...
                                <button type="submit" class="btn btn-primary">{{ __('Reward Update') }}</button>
                            </form>
                        </div>
                    </div>
                </div>
