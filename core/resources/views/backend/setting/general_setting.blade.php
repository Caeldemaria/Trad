                        ...
                        <div class="card-body">
                            ...
                            <form action="" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-3">
                                        <label for="currency_sym">{{ __(' Currency Symbol') }}</label>
                                        <input type="text" name="currency_sym" class="form-control"
                                            placeholder="Enter Currency Symbol" value="{{ @$general->currency_sym ?? '' }}">
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="refer_need" placeholder="@lang('Minimum Trading Amount')" class="form-control form_control" value="{{ @$general->refer_need }}">
                                    ...
                                    <div class="form-group col-md-12 mt-2">
                                        <button type="submit" class="btn btn-primary w-100">{{ __('Update General Setting') }}</button>
                                    </div>
