...
<div class="container">
    ...
    <div class="card my-3"><div style="background: #134d00;"
    ...
    <div class="d-none" id="currentPath">Password</div><div style="background: #134d00;"
    <!-- Account Navigation -->
    ...
    <form id="passwordChange" action="{{ route('user.update.password') }}" method="POST">
        ...
        <div class="card mb-4"><div style="background: #134d00;"
...
<div style="background: #134d00;"
        ...
        </div><div style="background: #134d00;"
    </form>
</div>
