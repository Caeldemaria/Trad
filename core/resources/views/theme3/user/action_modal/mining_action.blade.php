    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Start Trading</h5>
            </div>
                            ...
                            <div class="card-body p-2">
                                <div class="row align-items-center">
                                    <div class="col text-start">
                                        <h6 class="mb-0 text-dark small-font-lg text-start">Current Balance:</h6>
                                    </div>
                                    <div class="col-auto">
                                        <h6 class="mb-0 text-dark small-font-lg">{{ @$general->currency_sym }}{{ showAmount(@$user->balance) }}</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
